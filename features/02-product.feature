...
# COMMENTED OUT - Bug in application: "Add Product" button doesn't open modal
...
#    And End test
  ...
  Scenario: Delete a Product
    Given User exists
    And Is Logged In
    And There is a Product Created
    When Open dashboard page
    And Open sandwich menu
    And Click on Product Management
    And Save Amount of Records
    And Search for Created Product
    And Delete Created Product
